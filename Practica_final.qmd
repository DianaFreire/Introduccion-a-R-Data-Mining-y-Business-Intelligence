...
```{r}
 paste("Kama: ", mean(df_seeds[df_seeds$tipo=='Kama','area']))
 paste("Rosa: ", mean(df_seeds[df_seeds$tipo=='Rosa','area']))
 paste("Canadian: ", mean(df_seeds[df_seeds$tipo=='Canadian','area']))
```
...
**Respuesta**: ' Un boleano. Crea una nueva columna llamada is_kama que tiene el valor TRUE, cuando el tipo de semilla es Kama y FALSE en caso contrario.'
